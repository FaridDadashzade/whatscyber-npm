...
async function worktype(type, Language) {
  ...
  if (type == 'private') {
    if (Language == 'TR') {
      data = "*WhatsCyber Private Olarak Çalışıyor! 🦸‍♀️*\n\n" +
