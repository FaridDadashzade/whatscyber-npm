...
async function worktype(type, Language) {
  ...
  if (type == 'private') {
    if (Language == 'TR') {
      data = "*WhatsSiri Private Olarak Çalışıyor! 🐺*\n\n" +
